...
name_data = "Lab4Data.gdb" # folder_data + "\\Lab4Data.gdb"
...
# step 3
name_data = folder_data + "\\" + name_data
...
# step 9
arcpy.TableToTable_conversion(name_data + "\\Garage_Intersect", folder_data, 'nearbyBuildings.csv')
