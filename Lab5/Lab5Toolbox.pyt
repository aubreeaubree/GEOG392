...
class Tool(object):
    def __init__(self):
        ...
        self.description = "Determines which buildings on A&M's campus are near target building"
    ...
    def getParameterInfo(self):
        ...
        param3 = arcpy.Parameter(displayName="Garage Output Points",name="garage_Name",datatype="GPString",parameterType="Required",direction="Input")
    ...
    def execute(self, parameters, messages):
        ...
        if shouldContinue:
            ...
            arcpy.AddError("Sorry, we could not find the building you entered")
        return
